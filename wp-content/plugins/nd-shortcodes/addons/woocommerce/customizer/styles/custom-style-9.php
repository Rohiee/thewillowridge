...
<style>
	...
	#nd_options_woocommerce_content ul.products li.product a.button.product_type_variable { background-color: <?php echo $nd_options_customizer_woocommerce_color_red;  ?> !important; }
	body.single-product .related.products ul.products li.product a.button.product_type_variable { background-color: <?php echo $nd_options_customizer_woocommerce_color_red;  ?> !important; }
