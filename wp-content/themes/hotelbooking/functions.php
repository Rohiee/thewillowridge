...
function nicdark_register_required_plugins() {
    ...
    $nicdark_plugins = array(
        ...
        //elementor
        array(
            'name'      => esc_html__( 'Elementor', 'hotelbooking' ),
            'slug'      => 'elementor',
            'required'  => true,
        ),
        ...
        //woocommerce
        array(
            'name'      => esc_html__( 'WooCommerce', 'hotelbooking' ),
            'slug'      => 'woocommerce',
            'required'  => true,
        ),
        ...
        //ND Projects
        array(
            'name'               => esc_html__( 'Cost Calculator', 'hotelbooking' ),
            'slug'               => 'nd-projects', // The plugin slug (typically the folder name).
            'source'             => get_template_directory().'/plugins/nd-projects.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),

        //ND Elements
        array(
            'name'               => esc_html__( 'Elements For Elementor', 'hotelbooking' ),
            'slug'               => 'nd-elements', // The plugin slug (typically the folder name).
            'source'             => get_template_directory().'/plugins/nd-elements.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),

        //ND Booking
        array(
            'name'               => esc_html__( 'Hotel Booking', 'hotelbooking' ),
            'slug'               => 'nd-booking', // The plugin slug (typically the folder name).
            'source'             => get_template_directory().'/plugins/nd-booking.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),
        ...
        array(
            ...
            'slug'               => 'nd-shortcodes', // The plugin slug (typically the folder name).
            'source'             => get_template_directory().'/plugins/nd-shortcodes.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),

        //ND Restaurant
        array(
            'name'               => esc_html__( 'Restaurant Reservations', 'hotelbooking' ),
            'slug'               => 'nd-restaurant-reservations', // The plugin slug (typically the folder name).
            'source'             => get_template_directory().'/plugins/nd-restaurant-reservations.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),
...
function nicdark_google_fonts_url() {
    ...
    if ( 'off' !== _x( 'on', 'Google font: on or off', 'hotelbooking' ) ) {
        $nicdark_font_url = add_query_arg( 'family', urlencode( 'Gilda+Display|Roboto:300,400,500,700' ), "//fonts.googleapis.com/css" );
    }
