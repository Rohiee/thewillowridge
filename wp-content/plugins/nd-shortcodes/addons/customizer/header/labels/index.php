...
function nd_options_customizer_labels_style(){
	...
	<style type="text/css">
		...
		#nd_options_header_6 .menu li.nd_options_slide_label > a:after { content: "<?php esc_html_e('SLIDE','nd-shortcodes') ?>"; float: right; background-color: <?php echo $nd_options_customizer_labels_color_hot; ?>; border-radius: 3px; color: #fff; font-size: 10px; line-height: 10px; padding: 3px 5px; }

		/*demo*/
		.nd_options_navigation_type .menu li.nd_options_demo_label > a:after,
		#nd_options_header_5 .menu li.nd_options_demo_label > a:after,
		#nd_options_header_6 .menu li.nd_options_demo_label > a:after { content: "<?php esc_html_e('DEMO','nd-shortcodes') ?>"; float: right; background-color: <?php echo $nd_options_customizer_labels_color_hot; ?>; border-radius: 3px; color: #fff; font-size: 10px; line-height: 10px; padding: 3px 5px; }
